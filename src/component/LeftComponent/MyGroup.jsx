...
const MyGroup = (curr) => {
  ...
  return (
    <div className='xyz'>
        <ul className='che'>
          <div onClick={pixel < 469 ? () => setMediaToggle(true) : () => setMediaToggle(false)} className='group-container'>
            <p className='initials' style={{ backgroundColor:color }}>{findInitials(name)}
            </p>
